...
interface ICurvePool {
  ...
  function exchange_underlying(address pool, int128 i, int128 j, uint256 dx, uint256 min_dy) external payable;
  ...
  function add_liquidity(address pool, uint256[3] calldata amounts, uint256 min_mint_amount) external payable;
  function add_liquidity(address pool, uint256[4] calldata amounts, uint256 min_mint_amount) external payable;
  function add_liquidity(address pool, uint256[5] calldata amounts, uint256 min_mint_amount) external payable;
  function add_liquidity(address pool, uint256[6] calldata amounts, uint256 min_mint_amount) external payable;
  function calc_token_amount(address pool, uint256[3] calldata amounts, bool deposit) external view returns (uint256);
  function calc_token_amount(address pool, uint256[4] calldata amounts, bool deposit) external view returns (uint256);
  function calc_token_amount(address pool, uint256[5] calldata amounts, bool deposit) external view returns (uint256);
  function calc_token_amount(address pool, uint256[6] calldata amounts, bool deposit) external view returns (uint256);
  ...
  function remove_liquidity_one_coin(uint256 _token_amount, int128 i, uint256 min_uamount, bool boolean) external;
  function remove_liquidity_one_coin(uint256 _token_amount, uint256 i, uint256 min_uamount, bool boolean) external;
  function remove_liquidity_one_coin(address pool, uint256 _token_amount, int128 i, uint256 min_amount) external;
