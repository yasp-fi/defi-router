...
// abstract contract UniswapV3Module is IUniswapV3SwapCallback, PeripheryPermit2 {
...
//     address payer
//   ) internal {
//     // use amountIn == Constants.MAX_BALANCE as a flag to swap the entire balance of the contract
//     if (amountIn == Constants.MAX_BALANCE) {
